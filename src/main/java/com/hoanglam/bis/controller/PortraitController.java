...
public class PortraitController {
    ...
    @PostMapping("/portraits/run")
    public ResponseEntity<ApiResponse<Void>> runPortraitsStep(@PathVariable UUID projectId) {
        pipelineService.startPortraitsStep(projectId);
        return ResponseEntity
                .status(HttpStatus.ACCEPTED)
                .body(ApiResponse.success("Portraits generation started", null));
    }
}
