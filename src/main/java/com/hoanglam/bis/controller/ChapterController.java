...
public class ChapterController {
    ...
    @PostMapping("/chapters/run")
    public ResponseEntity<ApiResponse<Void>> runChaptersStep(@PathVariable UUID projectId) {
        pipelineService.startChaptersStep(projectId);
        return ResponseEntity
                .status(HttpStatus.ACCEPTED)
                .body(ApiResponse.success("Chapters generation started", null));
    }
}
